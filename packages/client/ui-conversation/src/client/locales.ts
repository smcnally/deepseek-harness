...
export const zh = {
  ...
  'settings.enter.newline.title': 'Enter 键行为',
  'settings.enter.newline.description': 'Enter 插入换行；Cmd/Ctrl+Enter 发送（繁忙时按上方设置插话或排队）',
  'settings.enter.newline.send': 'Enter 发送',
  'settings.enter.newline.newline': 'Enter 换行',
...
export const en = {
  ...
  'settings.enter.newline.title': 'Enter key',
  'settings.enter.newline.description': 'Enter inserts a newline; Cmd/Ctrl+Enter sends (and steers or queues while busy per the setting above)',
  'settings.enter.newline.send': 'Enter sends',
  'settings.enter.newline.newline': 'Enter inserts a newline',
