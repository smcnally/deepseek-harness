/** Composer Enter preferences stored in the Host user-settings document. */
...
/** Field carrying whether plain Enter inserts a newline instead of submitting. */
export const NEWLINE_ENTER_FIELD = 'newlineEnter'

/** Default keeps plain Enter as the submit gesture. */
export const DEFAULT_NEWLINE_ENTER = false
...
export interface ConversationSettings {
  ...
  /**
   * Whether plain Enter inserts a newline instead of submitting. When set,
   * Cmd/Ctrl+Enter performs the submission plain Enter would have performed.
   */
...
export const ConversationSettingsSchema: z<ConversationSettings> = z.object({
  ...
  [NEWLINE_ENTER_FIELD]: z.boolean().default(DEFAULT_NEWLINE_ENTER),
})
